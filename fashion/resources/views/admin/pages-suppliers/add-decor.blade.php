    ...
    <div class="col-md-8 offset-md-2">
        <div class="panel panel-danger">
            ...
            <div class="panel-body pt-5">
                    <form class="floating-labels mt-5 ajaxUpload" action="{{ route('add.decor.supplier.post') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group col-md-6 mb-5 float-left">
                            <input type="text" class="form-control" id="decor" required name="title" ><span class="highlight"></span> <span class="bar"></span>
                            <label for="decor">نام دکور</label>
                            <span class="help-block text-danger small error-decor"></span>
                        </div>
                        <div class="form-group col-md-6 mb-5 float-left">
                            <input type="text" class="form-control" id="decorcode" required name="code" value="{{$decor_id}}"><span class="highlight"></span> <span class="bar"></span>
                        ...
                        <div class="form-group col-md-12 mb-5 float-left">
                            <select class="select2 m-b-10 select2-multiple" multiple data-placeholder="انتخاب کنید"  id="products_id" name="products_id[]" >
                                @foreach ($products as $product)
                                    <option value="{{ $product->productid }}">{{ $product->product }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group  row w-100">
                            <label for="imageUrl">عکس دکور</label>
