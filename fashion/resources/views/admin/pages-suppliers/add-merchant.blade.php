    ...
    <div class="col-md-12">
        <div class="panel panel-danger">
            ...
            <div class="panel-body pt-5">
                ...
                <form class="floating-labels mt-5 ajaxUpload" action="{{ route('add.merchant.post.type.suppliers') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @if ($type == 'transporter')
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                ...
                                <div class="form-group col-md-12" style="overflow: hidden;">
                                    <select multiple id="suppliers-select-" class="select2" name="suppliers[]">
                                        @foreach ($suppliers as $supp)
                                            <option value="{{ $supp->manufacturerid }}" selected >{{ $supp->manufacturer }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
