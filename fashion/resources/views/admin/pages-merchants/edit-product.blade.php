							...
							<div class="sttabs tabs-style-linemove">
								...
								<div class="content-wrap text-center">
									<section id="section-linemove-1">
										@include('admin.components.product.edit-step1',['product' => $product, 'categories' => $categories, 'suppliers'=> $suppliers ])
									</section>
									<section id="section-linemove-2">
										@include('admin.components.product.edit-step2',['product' => $product ])
									</section>
									<section id="section-linemove-3">
										@include('admin.components.product.edit-step3',['product' => $product ])
									</section>
									<section id="section-linemove-4">
										@include('admin.components.product.edit-step4',['product' => $product, 'extrafields' => $extrafields ])
									</section>
									<section id="section-linemove-5">
										@include('admin.components.product.edit-step5',['product' => $product, 'price' => $price ])
									</section>
