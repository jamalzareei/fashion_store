<form class="floating-labels mt-5 ajaxUpload" action="{{ route('edit.product.step.1.supplier.post') }}" method="POST" enctype="multipart/form-data">
    @csrf
    ...
    <div class="form-group  row w-100">
        ...
        <input type="file" id="imageUrl" name="imageUrl" class="dropify file-upload" data-default-file="{{($product->thumbnail) ? 'http://cerampakhsh.com/'.str_replace('/var/www/vhosts/cerampakhsh.com/httpdocs/','',$product->thumbnail->image_path) : ''}}">
        <small>
