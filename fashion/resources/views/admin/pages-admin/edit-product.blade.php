                    ...
                    <div class="panel-body pt-5">
                        <div class="row">
                            <div class="col-md-6 text-right">
                                <button onclick="delete_('{{ route('panel.admin.product.delete.post', ['id'=>$product->id]) }}', '{{ route('panel.admin.products') }}')" class="btn btn-youtube waves-effect float-left waves-light"><i class="fa fa-times"></i> حذف محصول</button>
                            </div>
							...
							<div class="sttabs tabs-style-linemove">
								<nav>
									<ul>
										...
										<li><a href="#section-linemove-3" class="sticon ti-help"><span>اطلاعات اضافی محصول , متا سئو</span></a></li>
								...
								<div class="content-wrap text-center">
									<section id="section-linemove-1">
										@include('admin.components.product-suppliers.edit-step1',['product' => $product, 'categories' => $categories ])
									</section>
									...
									<section id="section-linemove-5">
										@include('admin.components.product-suppliers.edit-step5',['product' => $product, 'price' => null ])
									</section>
